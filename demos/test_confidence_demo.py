...
async def confidence_engine_via_api():
    ...
    try:
        ...
        source_text = "A Constituição Federal de 1988 estabelece os princípios fundamentais do Estado brasileiro, garantindo direitos e deveres aos cidadãos."
        target_text = "A Constituição de 1988 define as bases do Estado brasileiro, assegurando direitos aos cidadãos."
